...
from app.schema.delete_intern_registration import DeleteInternRegistration
...
@intern_router.post('/delete-registration')
@login_required(
    token_types=["Admin"]
)
async def delete_registration(
    ...
    try : 
        req = DeleteInternRegistration().load(data)
    ...
    res = await InternController().delete_intern_registration(req["registration_id"])
    return res
